...
## 0.3.0 - 2026-02-24
### Added
- Added support for tagging services and resolving tagged services in a collection
- Added Attribute `NoAutoResolve` to prevent services from being auto resolved

## 0.2.0 - 2026-02-23
### Added
- Added support to pre-set parameters for resolving
